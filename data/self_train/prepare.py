...
if __name__ == '__main__':
    ...
    if opt.dataset == 'KPTimes':
        opt.train = os.path.join(opt.data_dir, 'KPTimes.test.jsonl')
        opt.valid = os.path.join(opt.data_dir, 'KPTimes.test.jsonl')
    ...
    if opt.dataset == 'self_train':
        opt.train = os.path.join('./', 'train.jsonl')
        opt.valid = os.path.join('./', 'valid.jsonl')
        opt.test = os.path.join('./', 'test.jsonl')
